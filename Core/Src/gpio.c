...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, BADC_EN_Pin|SPI_CS_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = BADC_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BADC_EN_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = UP_Pin|DOWN_Pin|FORWARD_Pin|BACK_Pin;
